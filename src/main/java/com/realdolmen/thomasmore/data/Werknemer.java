...
public class Werknemer extends User implements Serializable {
    ...
    public Werknemer(String voornaam, String familienaam, int userLevel, String adres, String gemeente, String postcode, String email, String wachtwoord, String telefoon) {
